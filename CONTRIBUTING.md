...
1. Check [Issues](https://github.com/tbaur/bluesound-controller/issues) and [FEATURE_PROPOSALS.md](docs/FEATURE_PROPOSALS.md) for existing proposals
...
- **New features**: See [FEATURE_PROPOSALS.md](docs/FEATURE_PROPOSALS.md)
